...
{	
	...
	gDoneButton      = new AppleGlassButton(document.getElementById("doneButton"), LocalizedStringForKey("Done"), FlipToFront);
	gWhiteInfoButton = new AppleInfoButton(document.getElementById("infoButton"), document.getElementById("front"), "white", "white", FlipToBack);
	...
	if (twilightZenith) document.getElementById('twilight').value = twilightZenith;
